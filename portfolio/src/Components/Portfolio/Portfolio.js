        ...
        <div className='container'>
          ...
          <div className='content grid'>
            {Portfolio_data.map((value, index) => {
              return <Card key={index} link2={value.link2} desc1={value.desc1} link1={value.link1} image={value.image} category={value.category} totalLike={value.totalLike} title={value.title} />
            })}
